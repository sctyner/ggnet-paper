...
\hh{Despite the large number of vertices, the protein interaction network has a relatively small number of edges (4480 out of over 2.2 Million theoretically possible connections). Next, we examine networks with a higher edge probability.
}
