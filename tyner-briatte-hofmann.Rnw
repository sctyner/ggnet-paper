...
\hh{In addition to the wide-spread use of \pkg{ggplot2}, its design based on the Grammar of Graphics \citep{wilkinson:1999} makes it relatively easy to extend. Many extensions already exist:}
% \fb{
...
# create plot
ggplot(data = MMnet, aes(from_id = Name1, to_id = Name2)) + geom_net()
