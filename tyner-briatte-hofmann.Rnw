...
ggplot(data = MMnet, aes(from_id = Name1, to_id = Name2)) +
  geom_net(aes(colour = Gender), layout = "kamadakawai", 
           size = 1, label = TRUE, vjust = -0.6, ecolour = "grey60",
           directed = TRUE, fontsize = 3, 
           arrowgap = 0.01, arrowsize = .5, ealpha = 0.5) +
...
<<codefromfirstmmnet, echo=FALSE, eval=FALSE>>=
...
<<madmen_ggnet2, echo=FALSE, out.width='\\textwidth', fig.width=9, fig.height=9, eval=FALSE>>=
# create plot for ggnet2
set.seed(10052016)
ggnet2(mm.net, color = mm.col[ mm.net %v% "gender" ],
       label = TRUE, label.color = mm.col[ mm.net %v% "gender" ],
       size = 4, vjust = -0.6, layout = "kamadakawai")
