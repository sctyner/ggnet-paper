...
\hh{I like that idea! We would need to include the time for  the layout for a fair comparison though ...}
...
# this code chunk will need to be moved eventually - just for trying things out right now.
if (!file.exists("timings.csv")) {
