...
The long list of arguments that can be passed to the \code{ggnet2} function offers extensive control over the aesthetics of the plot that it returns, including %through 
