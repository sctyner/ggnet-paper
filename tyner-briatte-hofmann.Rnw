...
\fb{Attempt to do so in paragraph below.}
...
\fb{Paragraph below now contains a few sentences to make these changes clear.}
...
=======
  ...
  theme_net() +
>>>>>>> 7255722524e4a0177e2b7a2892cb559c5545c91e
  theme(legend.position = "bottom")
@
\end{subfigure}
%
